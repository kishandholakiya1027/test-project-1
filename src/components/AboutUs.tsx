...
const AboutUs: React.FC = () => {
        ...
        >
          ...
          <div className="lg:text-[14px] text-[12px]">
            <p className="mt-4 custom-text ">
              Born from a vision of a more equitable digital future, the Kalp
              Decentra Foundation emerged in 2020 before formally consolidating
              in the year 2023 as a response to the growing need for secure,
              compliant, and inclusive blockchain infrastructure. Our founders,
              led by Tapan Sangal, recognized that the true potential of
              decentralized technology could only be realized if it was built on
              a foundation of regulatory compliance and community-driven
              governance.
            </p>
            <p className="mt-6">
              Motivated by the challenges of fragmented liquidity, regulatory
              uncertainty, and the need for scalable, interoperable solutions,
              we set out to create a Digital Public Infrastructure that would
              democratize access to blockchain technology while maintaining the
  ...
  const FoundingMembers = () => {
    return (
      <div
        ref={containerRef}
        className="flex lg:flex-wrap lg:gap-20 lg:ml-[46px] lg:mt-0 mt-4 overflow-x-auto space-x-8"
      >
        <div className="transition-transform duration-[1500ms] lg:max-w-[264px]">
          ...
          <div className="mt-4">
            ...
            <p className="mt-6 lg:text-[14px] text-sm hidden md:block">
              The visionary founder of Kalp Decentra Foundation, leading the
              mission for a regulated decentralized infrastructure powered by
            ...
            <Image
              src={linkedin}
              alt="Linkedin"
              className="mt-4 cursor-pointer w-6 h-6"
              onClick={() =>
                window.open(
                  "https://www.linkedin.com/in/tapan-sangal-94299299/",
                  "_blank"
                )
              }
            />
        ...
        <div className="transition-transform duration-[1500ms] max-w-[264px]">
          ...
          <div className="mt-4">
            ...
            <p className="mt-6 lg:text-[14px] text-sm custom-text hidden md:block   ">
              The Chief Blockchain Architect, became a part of the team with a
              specialization in cryptography, blockchain technology, and
              information security. His previous roles at  CATALOG | REN LABS,
              and IIIT Hyderabad equipped him with the skills to design secure,
              scalable, and robust blockchain protocols.
            </p>
          </div>
          <Image
            src={linkedin}
            ...
            onClick={() =>
              window.open(
                "https://www.linkedin.com/in/realrajshubham/",
                "_blank"
              )
            }
          />
      ...
      <div ref={containerRef} className="lg:w-[63%] w-full px-4">
        <div className="transition-transform duration-[1500ms]">
          ...
          <div className="text-[14px] lg:text-xs custom-text">
            <p className="mt-4 text-xs lg:text-[14px]">
              At Kalp Decentra Foundation, our actions are guided by a set of
              core principles:
            </p>
            <ul className="list-decimal text-sm lg:text-[13px] list-inside text-start mt-4 pl-3 lg:space-y-3 space-y-2">
              <li className="text-sm lg:text-[14px]">
                <span className="text-sm lg:text-[14px] font-semibold">
                  Compliance-First Approach:
                </span>{" "}
                We believe innovation thrives within ethical and legal
                frameworks.
              </li>
              <li>
                <span className="text-sm lg:text-[14px] font-semibold">
                ...
                We commit to open governance and clear communication in all our
                operations.
              </li>
              <li>
                <span className="text-sm lg:text-[14px] font-semibold">
                ...
                We strive to create technology that empowers all, regardless of
              ...
              <li>
                ...
                Our commitment to the environment is embedded in our
              ...
              <li>
                ...
                We believe in the power of collective wisdom and shared
                governance.
              </li>
            </ul>
          </div>
      ...
      <div ref={containerRef} className="lg:w-[62%] w-full px-4">
        <div className="transition-transform duration-[1500ms]">
          ...
          <div className="text-[12px] lg:text-[13px] custom-text">
            <p className="mt-4">
              The Kalp Decentra Foundation operates under a robust governance
              structure designed to ensure transparency, accountability, and
              community participation. Our framework includes:
            </p>
            <ul className="list-disc text-start pl-3 lg:py-5 lg:text-[13px]">
              <li>
                A diverse Board of Directors with expertise across relevant
                fields
              </li>
              <li>
                Multiple specialized committees overseeing various aspects of
                our operations
              </li>
              <li>
                A two-tier grievance redressal mechanism to ensure fair
                resolution of issues
              </li>
              <li>
                Regular internal and external audits to maintain the highest
                standards of operation
              </li>
            </ul>
            <p className="">
              Our governance model is designed to evolve with the needs of our
              community and the changing landscape of blockchain technology. We
              believe in the power of decentralized decision-making, balanced
              with the need for expert guidance and regulatory compliance.
            </p>
            <p>
              For a detailed look at our governance structure, please review our
              full Governance Framework Document.
            </p>
            {isDesktop ? (
              <p className="mt-4">
                Join us in our mission to create a more equitable, secure, and
                innovative digital future. Together, we are not just building
                technology – we are shaping the future of global digital
                interaction.
              </p>
            ) : null}
          </div>
    ...
    <div className="relative w-full mt-12 lg:mt-0" id="about-us">
      ...
      <div className="relative z-10 lg:flex flex-wrap lg:gap-16 h-full lg:px-10 px-4 lg:py-10 py-6 text-[#fff]">
        <div
          className={`${
            isDesktop
              ? "flex gap-[24px] md:block overflow-x-auto"
              : "flex overflow-x-auto space-x-8"
          }`}
        >
          {text?.map((data: any, index: any) => (
            <div
              key={index}
              className={`w-full lg:text-[24px] text-base lg:pb-[22px] pb-5 ${
                index === 3 ? "" : "lg:border-b border-[#B1B1B1]/40"
              } transition-transform duration-[1500ms] cursor-pointer ${
                data === select ? "font-bold " : "text-[#B1B1B1]/40"
              } lg:mb-[22px] text-nowrap`}
              onClick={() => handleChange(data)}
            >
              <p className={`${data === select ? "font-semibold" : ""}`}>
                {data}
              </p>
            </div>
          ))}
        ...
        {select === "FOUNDING MEMBERS" ? <FoundingMembers /> : null}

        {select === "OUR VALUES" ? <OurValues /> : null}

        {select === "GOVERNANCE FRAMEWORK" ? <Governance /> : null}
      </div>
      <div className="absolute top-0 right-0 bg-[#000] pt-32 pb-8 h-full w-[7%] z-20 ">
        <Image src={overlayImg} alt="Overlay" width={60} />
      </div>
