    ...
    return (
        <div className='lg:mt-[120px] mt-24'>
            <div className='flex flex-col justify-center items-center' >
                <h1 className="lg:text-[32px] text-md font-bold md:mb-4 mb-2">Blogs</h1>
...
<div onMouseEnter={() => setHoveredIndex(index)}
                        ...
                        <Image src={item?.hoveredimage} alt="kalp Logo" className="w-full h-full ease-in-out grayscale hover:grayscale-0 transition-all duration-1500" />
                                </div>
                  <div>
