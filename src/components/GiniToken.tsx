...
import giniImage from "../../public/images/Mask group.svg";
import giniColoured from "../../public/images/giniColoured.jpg";
import giniToken from "../../public/images/giniToken.jpg";
...
export default function GiniToken() {
  ...
  useEffect(() => {
    if (inView) {
      setAnimationClassLeft("animate__animated animate__fadeInLeft");
  ...
  return (
    <div className="lg:mt-[120px] mt-12" id="gini" ref={ref}>
      <div className="lg:flex items-center justify-center w-full">
        <div className="flex md:justify-between items-center lg:w-[40%] justify-center">
          ...
          <div className="relative h-[1px] w-[30%] hidden lg:block">
            ...
            <div className="absolute left-0 h-full w-full flex justify-start">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to right, rgba(211,211,211,1), rgba(211,211,211,0))",
                }}
              >
          ...
          <div className="flex items-center justify-between w-[150px] h-[55px] bg-[#000]">
            ...
            <div className="w-[50%] text-white text-[20px] border-l border-[#595959] border-solid text-center">
              GINI
            </div>
          </div>
          ...
          <div className="relative h-[1px] w-[30%] hidden lg:block">
            ...
            <div className="absolute right-0 h-full w-full flex justify-end">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to left, rgba(211,211,211,1), rgba(211,211,211,0))",
                }}
              >
                <svg width="100%" height="100%">
                  <defs>
      ...
      <div className="lg:flex flex-col gap-4 justify-center lg:px-6 text-center item-center lg:mt-10 mt-4">
        <p className="lg:text-[32px] font-bold">
          The Kalp ecosystem offers a game-changing solution.
        </p>
        <p className="lg:text-[16px] text-[13px] lg:px-6 ">
          It seamlessly merges the best of permissionless and permissioned
          networks, ensuring regulatory compliance without sacrificing
          decentralization. Governed by the Kalp Foundation and accessed via the{" "}
          <span className="font-bold">{`"Gini"`}</span> token.
        </p>
      </div>
      {!isDesktop && (
        <div
      ...
      <div className="lg:flex lg:gap-[62px] gap-6 items-center lg:px-4 px-2 justify-between lg:mt-10 mt-4">
        {/* Text Section */}
        <div className={`lg:w-1/2 w-full ${animationClassLeft}`}>
          <p className="lg:text-[24px] text-md font-semibold">
            Our Digital Catalyst
          </p>
          <p className="lg:mt-[32px] mt-4 lg:text-[14px] text-[12px]">
            At the heart of the KALP Foundation&apos;s mission lies our digital
            currency, Gini. Designed to empower individuals and communities,
            Gini serves as a tool for inclusivity, transparency, and equitable
            reward within our ecosystem. Gini is a utility fuel to access the
            services of the Kalp DPI.
          </p>
          <p className="mt-2 lg:text-[14px] text-[12px] lg:mt-6 mt-4">
            Gini embodies the values and principles upheld by the KALP
            Foundation, a non-profit organization dedicated to responsible
            innovation and societal progress. As a token governed by the
            Foundation, Gini represents our commitment to democratizing access
            to digital assets and fostering a community-driven economy.
          </p>
        ...
        {/* Image Section */}
        <div className={`lg:w-1/2 w-full ${animationClassRight}`}>
          {isDesktop ? (
            <div
